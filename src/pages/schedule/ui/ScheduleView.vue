...
import { deleteScheduleEntryService, getMonthScheduleService, getScheduleTypesService, getWeekScheduleService, updateMonthScheduleService } from '@/entities/schedule/api/scheduleService';
