...
import CreateOrganizationStore from "@/features/create-organization-store/ui/CreateOrganizationStore.vue";
import OrganizationStoreDetail from "@/entities/store/ui/OrganizationStoreDetail.vue";
import type {
    ICreateOrganizationStoreForm,
} from "@/features/create-organization-store/model/types";
import type {
